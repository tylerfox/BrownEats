...
public class VDubMenuTask extends AsyncTask<Void, Void, String> {
    Context c;
    String clientId = "d4d562cc-42c3-42ba-aa44-4f045ae77112";
    LinearLayout layout;

    public VDubMenuTask(Context c) {
        this.c = c;
    }

    @Override
    protected String doInBackground(Void... params) {
        return GET("https://api.students.brown.edu/dining/menu?client_id=" + clientId + "&eatery=vdub");
    }
    ...
    public void addSection(JSONObject menu, String sectionName) {
        try {
            ...
            Toast.makeText(c, "Error creating menu sections.", Toast.LENGTH_LONG).show();
        }
    }
